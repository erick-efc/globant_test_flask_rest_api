...
################################################
@required_routes_bp.route('/api/upload_hist', methods=['POST'])
def upload_file():
    try:
...
################################################
@required_routes_bp.route('/api/historical_to_db', methods=['POST'])
...
################################################
@required_routes_bp.route('/api/batch_insert', methods=['POST'])
def batch_insert():
